...
def get_optimal_times(df, location, duration):
    ...
    # Add assigned datetime column for export
    ...
    return loc_util.head(3)[["Original_Date", "Next_Available_Time", "Remaining_Minutes", "Assigned_DateTime"]]

# ======================================
# 📤 EXCEL EXPORT
# ======================================
def export_optimized_schedule(df, location, optimized_df):
    ...
    with pd.ExcelWriter(output, engine="openpyxl") as writer:
        ...
        optimized_df.to_excel(writer, index=False, sheet_name="Optimized_Appointments")
...
if "data" in st.session_state:
    ...
    if st.button("📅 Find Next 3 Optimal Appointment Times"):
        ...
        if not results.empty:
            ...
            # ✅ Add Excel export including Assigned Dates
            export_optimized_schedule(df, location, results)
else:
